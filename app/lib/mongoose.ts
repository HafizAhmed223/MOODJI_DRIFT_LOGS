...
declare global {
  ...
  var mongooseConn: { promise: Promise<typeof mongoose> | null; conn: typeof mongoose | null } | undefined;
}
...
export async function connectToDatabase(): Promise<typeof mongoose> {
  ...
  if (!global.mongooseConn?.promise) {
    ...
    global.mongooseConn!.promise = mongoose.connect(MONGODB_URI, opts).then((m) => m);
  }
